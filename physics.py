...
class PhysicsEngine:
    ...
    def update_sim(self, hal_data, now, tm_diff):
        ...
        # Simulate gravity by negatively biasing elevator speed
        elevator_speed = hal_data['CAN'][6]['value'] - 0.3

        elevator_winch_distance = elevator_speed * (6 * tm_diff) * self.srxMagTicks
